const inputToRGB = require('../utils/tinycolor').inputToRGB;
...
cc.Class({
    ...
    onLoad: function () {
        ...
        let particleBg1 = inputToRGB( '#ebebeb' );//rgba(0, 0, 0, 20)';
        let particleBg2 = inputToRGB( '#333' );//'rgba(0, 0, 0, 204)';
        let particleBg3 = inputToRGB( '#f4f4f4' );//'rgba(255, 255, 255, 240)';

        let microParticlesColor = inputToRGB( 'black' );


        let lineColor = inputToRGB( 'black' );
        ...
        this.drawHair = function (g) {
            g.fillColor = inputToRGB( 'black' );
            g.strokeColor = inputToRGB( 'black' );
            g.lineWidth = 1;
    ...
    update: function (dt) {
        ...
        this.drawOutline(s);
        s.fillColor = inputToRGB('white');//cellBg;
        s.fill();
        ...
        g.lineWidth = 15;
        this.drawOutline(g);
        g.strokeColor = inputToRGB( 'white' );
        g.lineWidth = 13;
        this.drawOutline(g);
        g.strokeColor = inputToRGB( 'black' );
        g.lineWidth = 10;
